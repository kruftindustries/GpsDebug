...
public class GPS_Debug extends PApplet {
...
public int[][] read_NMEA() {
  ...
  if ( messagechecked & val != '\r' & val != '*') {
    tempsum += PApplet.parseChar(val);
  }

  if ( messagePending & !messagechecked) {
    serialbuff += PApplet.parseChar(val);
  }
...
public void updateGSV(String[] temp) {
  //println(temp);
  SV[PApplet.parseInt(temp[0])][0] = PApplet.parseInt(temp[0]);
  SV[PApplet.parseInt(temp[0])][1] = PApplet.parseInt(temp[1]);
  SV[PApplet.parseInt(temp[0])][2] = PApplet.parseInt(temp[2]);
  SV[PApplet.parseInt(temp[0])][3] = PApplet.parseInt(temp[3]);
  SV[PApplet.parseInt(temp[0])][5] = 0;
  SV[PApplet.parseInt(temp[0])][7] = 0;
  if (temp.length > 4) {
    SV[PApplet.parseInt(temp[4])][0] = PApplet.parseInt(temp[4]);
    SV[PApplet.parseInt(temp[4])][1] = PApplet.parseInt(temp[5]);
    SV[PApplet.parseInt(temp[4])][2] = PApplet.parseInt(temp[6]);
    SV[PApplet.parseInt(temp[4])][3] = PApplet.parseInt(temp[7]);
    SV[PApplet.parseInt(temp[4])][5] = 0;
    SV[PApplet.parseInt(temp[4])][7] = 0;
  }
  if (temp.length > 8) {
    SV[PApplet.parseInt(temp[8])][0] = PApplet.parseInt(temp[8]);
    SV[PApplet.parseInt(temp[8])][1] = PApplet.parseInt(temp[9]);
    SV[PApplet.parseInt(temp[8])][2] = PApplet.parseInt(temp[10]);
    SV[PApplet.parseInt(temp[8])][3] = PApplet.parseInt(temp[11]);
    SV[PApplet.parseInt(temp[8])][5] = 0;
    SV[PApplet.parseInt(temp[8])][7] = 0;
  }
  if (temp.length > 12) {
    SV[PApplet.parseInt(temp[12])][0] = PApplet.parseInt(temp[12]);
    SV[PApplet.parseInt(temp[12])][1] = PApplet.parseInt(temp[13]);
    SV[PApplet.parseInt(temp[12])][2] = PApplet.parseInt(temp[14]);
    SV[PApplet.parseInt(temp[12])][3] = PApplet.parseInt(temp[15]);
    SV[PApplet.parseInt(temp[12])][5] = 0;
    SV[PApplet.parseInt(temp[12])][7] = 0;
  }
}
...
public void updateGSA(String[] temp) {
  if (temp.length-3 > 0) {
    SV[PApplet.parseInt(temp[3])][4] = 1;
  }
  if (temp.length-3 > 1) {
    SV[PApplet.parseInt(temp[4])][4] = 1;
  }
  if (temp.length-3 > 2) {
    SV[PApplet.parseInt(temp[5])][4] = 1;
  }
  if (temp.length-3 > 3) {
    SV[PApplet.parseInt(temp[6])][4] = 1;
  }
  if (temp.length-3 > 4) {
    SV[PApplet.parseInt(temp[7])][4] = 1;
  }
  if (temp.length-3 > 5) {
    SV[PApplet.parseInt(temp[8])][4] = 1;
  }
  if (temp.length-3 > 6) {
    SV[PApplet.parseInt(temp[9])][4] = 1;
  }
  if (temp.length-3 > 7) {
    SV[PApplet.parseInt(temp[10])][4] = 1;
  }
  if (temp.length-3 > 8) {
    SV[PApplet.parseInt(temp[11])][4] = 1;
  }
  if (temp.length-3 > 9) {
    SV[PApplet.parseInt(temp[12])][4] = 1;
  }
  if (temp.length-3 > 10) {
    SV[PApplet.parseInt(temp[13])][4] = 1;
  }
  if (temp.length-3 > 11) {
    SV[PApplet.parseInt(temp[14])][4] = 1;
  }
  DOP[0] = PApplet.parseFloat(temp[15]);
  DOP[1] = PApplet.parseFloat(temp[16]);
  DOP[2] = PApplet.parseFloat(temp[17]);
}
...
public void draw_SV(int[][] tempSV) {
  float x, y;
  int r=45;
  textSize(5);
...
public void draw_SNR(int[][] tempSV) {
  int id1 = 0, id2 = 0, k = 0;
  float snr;
  textSize(6);
  for (int i = 1; i < tempSV.length; i++) {
  ...
  public void settings() {  size(280, 400); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "GPS_Debug" };
    if (passedArgs != null) {
